	...
	<div class="span5">
		<div class="logo">
			<a href="${pageContext.request.contextPath }/index.action">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="彭煌">
			</a>
		</div>
	</div>
	<div class="span9">
	...
	<%@include file="menu.jsp"%>
		...
		<div class="span6">
			...
			<s:iterator var="c" value="#session.cList">
						<dl>
							<dt>
								<a href="${pageContext.request.contextPath }/product_findByCid.action?cid=<s:property value="#c.cname"/>&page=1"><s:property value="#c.cname"/></a>
							</dt>
		...
		<div class="span18 last">
			...
			<form id="cartForm" action="${pageContext.request.contextPath }/cart_addCart.action" method="post">
				<input type="hidden" name="pid" value="<s:property value="model.pid"/>"></input>
				<div class="action">			
						<dl class="quantity">
							<dt>购买数量:</dt>
							<dd>
